...
const ProjectModal: React.FC<ProjectModalProps> = ({ onClose, projects }) => {
    ...
    /**
     * Sets the project name state to a new three-word name composed of unique words from a predefined list.
     *
     * The generated name consists of three distinct words joined by single spaces and converted to lowercase, and it is applied by calling `setProjectName`.
     */
    function setRandomProjectName(): void {
        ...
        setProjectName(random.toLowerCase);
    }

    /**
     * Checks whether any required project input is missing or the supplier email is invalid.
     *
     * @returns `true` if the project name, client name, or supplier name is empty after trimming, or if the supplier email is invalid; `false` otherwise.
     */
                ...
                <div className={styles.content}>
                    <div className={styles.fieldContainer}>
                        ...
                        <div className={styles.projectContainer}>
                            <input type="text" className={styles.fieldInput} value={projectName.toLowerCase()} onChange={(e) => setProjectName(e.target.value)} />
                    ...
                    <div className={styles.fieldContainer}>
                        ...
                        <select
                            className={styles.fieldInput}
                            value={activityType}
                            onChange={(e) => setActivityType(e.target.value as Project['activityType'])}
                        >
